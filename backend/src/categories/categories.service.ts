...
export class CategoriesService {
  ...
  async seedDefaults(userId: string) {
    ...
    const categories: Array<Partial<Category>> = [
        ...
        { userId, kind: CategoryKind.EXPENSE, name: 'Food & Drinks', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Transport', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Restaurant', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Coffee or snacks', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Sport', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Health', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Personal Care', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Cinema', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Gifts', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Telecommunication', isSystem: true },
        { userId, kind: CategoryKind.EXPENSE, name: 'Emergency fund', isSystem: true },
